...
export function Presentation() {
  ...
  const profile = {
    name: 'Rahi Uppal',
    age: '22 years old',
    location: 'Khour, Jammu & Kashmir, India',
    // Add a newline character after the emoji
    description:
      "Hey 👋\nI'm Rahi, a Venture Architect passionate about building data-driven solutions and innovative products. With experience across startups, consulting, and engineering, I love combining technical skills and business insight to solve complex problems.",
    ...
    <div className="mx-auto w-full max-w-5xl py-6 font-sans">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col space-y">
          ...
          >
            {['Data Analytics', 'Venture Architecture', 'NIT Srinagar', 'Entrepreneurship', 'Python'].map(
              (tag) => (
                <span
                  key={tag}
